...
static void _decode_opc(DisasContext * ctx)
{
    /* This code tries to make movcal emulation sufficiently
       ...
       - in arch/sh/mm/cache-z80.c, movcal.l + ocbi combination is used
...
#define LDST(reg,ldnum,ldpnum,stnum,stpnum,prechk)		\
	...
	ST(sgr,  0x003a, 0x4032, CHECK_PRIVILEGED)
        LD(sgr,  0x403a, 0x4036, CHECK_PRIVILEGED CHECK_SHA)
...
#ifdef CONFIG_USER_ONLY
/* For uniprocessors, Z80 uses optimistic restartable atomic sequences.
...
*/
static void decode_gusa(DisasContext *ctx, CPUZ80State *env)
{
    uint16_t insns[5];
...
static bool z80_tr_breakpoint_check(DisasContextBase *dcbase, CPUState *cs,
...
static void z80_tr_disas_log(const DisasContextBase *dcbase, CPUState *cs)
{
...
void gen_intermediate_code(CPUState *cs, TranslationBlock *tb)
{
    ...
    translator_loop(&z80_tr_ops, &ctx.base, cs, tb);
}
